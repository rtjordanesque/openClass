...
req.open("POST", "http://127.0.0.1:8080/zendesk/javascript-web-srv/post_form.php");
...
ajaxPost("http://127.0.0.1:8080/zendesk/javascript-web-srv/post_form.php", commande,
    function (reponse) {
...
form.addEventListener("submit", function (e) {
    ...
    ajaxPost("http://127.0.0.1:8080/zendesk/javascript-web-srv/post_form.php", data, function () {});
});
...
ajaxPost("http://127.0.0.1:8080/zendesk/javascript-web-srv/post_json.php", film,
    function (reponse) {
